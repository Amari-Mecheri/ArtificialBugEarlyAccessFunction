...
const pingRequestHeader = process.env.PING_REQUEST_HEADER;
...
module.exports = async function (context, req) {
    ...
    try {
        ...
        // 1. check if it's a ping request
        if (pingRequestHeader && req.headers[pingRequestHeader.toLowerCase()] === 'true') {
            context.res = {
                status: 200,
                body: 'OK' // simple text response for ping
            };
            return;
        }
